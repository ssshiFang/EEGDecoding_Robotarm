...
class MutiCovnet(nn.Module):
    def __init__(self): #输入 (32, 250)的EEG数据，输出xyz的坐标
        ...
        # 将四个分支的输出通道数拼接，32*8=256
        self.conv_fusion = nn.Conv2d(256, 256, kernel_size=1, bias=False)
    ...
    def forward(self, x):  # x: (B, 250, 32)
        ...
        x = torch.cat([b1, b2, b3, b4, b5, b6, b7, b8], dim=1) #(B, 128, 32, 250)
...
class Embedding(nn.Module):
    def __init__(self, in_channels=32, in_features=256, d_model=256):
        super().__init__()
