...
class Embedding(nn.Module):
    def __init__(self, in_channels=32, in_features=128, d_model=512):
        super().__init__()
...
class Connected_layer(nn.Module):
    def __init__(self, input_dim=512, hidden_dim=128, output_dim=6):
        super().__init__()
...
class EEGTransformerModel(nn.Module):
    def __init__(self, output_dim=6):
        ...
        self.attention = Muti_Attention(dim=512)
