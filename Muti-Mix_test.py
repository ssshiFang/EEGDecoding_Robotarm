...
import os
from r_model.Mix_model250_h8 import EEGTransformerModel
import numpy as np
...
def train(model, train_loader, test_loader, optimizer, criterion, device, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if val_pcc['pcc'] > best_pcc:
            ...
            save_model(model, f'f_model/e_9_t250_s50_w200/best_model{best_pcc:.2f}.pth')  # 保存最佳模型
...
def main():
    ...
    model_dir = os.path.join(parent_dir, 'data/9_t250_s50_w200')

    save_path = os.path.join(current_dir, 'f_model/e_9_t250_s50_w200/model.pth')
...
if __name__ == "__main__":
    # 获取当前脚本所在目录
    data_dir = r"D:\MyFolder\Msc_EEG\r_data\EMG\1_t250_s50_w200"
    model_dir = r"D:\MyFolder\Msc_EEG\f_model\e_9_t250_s50_w200"
